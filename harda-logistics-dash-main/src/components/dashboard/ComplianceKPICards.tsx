  ...
  const kpis = [
    {
      ...
      icon: AlertTriangle,
      color: pucExpired > 0 ? "bg-gradient-to-br from-red-500 to-red-600" : "bg-gradient-to-br from-orange-500 to-orange-600",
    ...
    },
    {
      ...
      icon: Shield,
      color: insuranceExpired > 0 ? "bg-gradient-to-br from-red-500 to-red-600" : "bg-gradient-to-br from-orange-500 to-orange-600",
    ...
    },
    {
      ...
      icon: Calendar,
      color: greenTaxExpired > 0 ? "bg-gradient-to-br from-red-500 to-red-600" : "bg-gradient-to-br from-green-500 to-green-600",
    ...
    },
    {
      ...
      icon: Clock,
      color: licenseExpired > 0 ? "bg-gradient-to-br from-red-500 to-red-600" : "bg-gradient-to-br from-yellow-500 to-yellow-600",
    ...
    },
    {
      ...
      icon: CheckCircle2,
      color: compliancePercentage >= 80 ? "bg-gradient-to-br from-green-500 to-green-600" : "bg-gradient-to-br from-red-500 to-red-600",
    ...
    },
    {
      ...
      icon: XCircle,
      color: delayedPercentage <= 20 ? "bg-gradient-to-br from-green-500 to-green-600" : "bg-gradient-to-br from-red-500 to-red-600",
        ...
        <Card key={index} className="relative overflow-hidden bg-white/70 backdrop-blur-sm border-0 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105">
          <CardContent className="p-6">
            ...
            <div className="mt-4 flex items-center justify-between">
              <Badge 
                variant={kpi.change === 'Critical' || kpi.change === 'Poor' || kpi.change === 'High' ? 'destructive' : 
                        kpi.change === 'Warning' || kpi.change === 'Monitor' ? 'default' : 'secondary'} 
                className="text-xs"
              >
                {kpi.change}
              </Badge>
